...
## Overview
This project’s goal is to predict house sale prices based on a variety of home related predictor variables.
...
- Used a log transformation on the response variable to reduce a large right skew.
### Step 2: Data Cleaning
- Used scikit-learns Pipelines to build a imputer for missing data, using median and standard scaler on numerical variables and most frequent values and one hot encoding for categorical variables.
...
## Results
- The results showed that tree-based models outperformed linear models for predicting future home sales.
